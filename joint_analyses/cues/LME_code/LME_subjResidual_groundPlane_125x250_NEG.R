...
df_125 <- read.csv('125_neg_groundPlane_participantData_for_lme.csv')
df_125$subjID <- factor(df_125$subjID) 
df_125$duration <- factor(df_125$duration)
df_125$stimulus <- factor(df_125$stimulus) 

df_grouped_125 <- read.csv('125_neg_groundPlane_participantData_grouped_for_lme.csv')
...
df <- rbind(df_125, df_250)

df_grouped <- rbind(df_grouped_125, df_grouped_250)
